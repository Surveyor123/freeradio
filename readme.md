...
| `Ctrl+Win+Shift+K` | Increase playback speed | Increases the playback speed of a podcast episode by 0.1x (pitch-preserving). Range: 0.5x to 2.0x. Requires `bass_fx.dll` to be placed in the add‑on folder. |
| `Ctrl+Win+Shift+J` | Decrease playback speed | Decreases the playback speed of a podcast episode by 0.1x. Requires `bass_fx.dll`. |
